...
(function(t, u) {
    ...
    function K(b, c) {
        ...
        var a = h.map,
            l = g;
        if (a)
            for (var d = 0, f = a.length; d < f && !(l = a[d], l = x(l) ? l(g) || g : g.replace(l[0], l[1]), l !== g); d++);
        return l
    }
    ...
    if (!t.seajs) {
        ...
        var m = f.emit = function(b, c) {
            ...
            k = n.getElementById("seajsnode") || k[k.length -
                1],
        ...
        e.prototype.onload = function() {
            ...
            var b = this._waitings,
                c, a;
            for (c in b)
                if (b.hasOwnProperty(c) && (a = r[c], a._remain -= b[c], 0 === a._remain)) a.onload();
